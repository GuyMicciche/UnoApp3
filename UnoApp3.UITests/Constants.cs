namespace UnoApp3.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5001/";
    public readonly static string iOSAppName = "com.companyname.UnoApp3";
    public readonly static string AndroidAppName = "com.companyname.UnoApp3";
